...
namespace SIPGAB
{
    class Utilerias
    {
        ...
        static string connectionString, connectionStringFox, connectionStringDBGAB;
        ...
        public static string validar_ip()
        {
            try
            {
                ...
                if (count <= 12)
                {
                    ...
                    ConnectionStringDBGAB = "Data Source= GABIRA1\\SQL2005;Initial Catalog=DBGAB;Connect Timeout=130;User ID=sa;  MultipleActiveResultSets=True";
                    //ConnectionStringDBGAB = "Data Source= 201.120.60.21\\SQL2005,2351,2351;Initial Catalog=DBGAB;Connect Timeout=130;User ID=sa;  MultipleActiveResultSets=True";                    
                    ...
                    //ConnectionString = "Data Source=201.120.60.21\\sql2005,2351;Initial Catalog=GAB_Irapuato;Connect Timeout=130;User ID=sa; MultipleActiveResultSets=True";                   
                }
                else
                {
                    ConnectionString = "Data Source=201.120.60.21\\SQL2005,2351,2351;Initial Catalog=GAB_Irapuato;Connect Timeout=130;User ID=sa; MultipleActiveResultSets=True";
                    ConnectionStringDBGAB = "Data Source= 201.120.60.21\\SQL2005,2351,2351;Initial Catalog=DBGAB;Connect Timeout=130;User ID=sa;  MultipleActiveResultSets=True";                    
                    //ConnectionString = "Data Source= gab.dyndns.org,2351;Initial Catalog=GAB_Irapuato;Connect Timeout=130;User ID=sa; MultipleActiveResultSets=True";                    
                }
        ...
        public static string ConnectionStringDBGAB
        {
            get { return Utilerias.connectionStringDBGAB; }
            set { Utilerias.connectionStringDBGAB = value; }
        }
